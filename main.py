...
def GetNewRSS(url):
    ...
    for post in f.entries:
        ...
        if not post.link in old:
            ...
            #notify.wecom_app(post.title,f.feed.title+delhtml(post.description), post.link)
            notify.wecom_app(f.feed.title+post.published, post.title+delhtml(post.description))
notify.wecom_bot(f.feed.title+post.published, post.title+delhtml(post.description))
